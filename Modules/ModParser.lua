...
local specialModList = {
	...
	["近期内你施加的每层中毒效果都使中毒持续时间se'd延长 (%d+)%%，最多可延长 100%%"]= function(num) return {  mod("EnemyPoisonDuration", "INC", num, { type = "Multiplier", var = "PoisonAppliedRecently", limit = 100, limitTotal = true})  } end,
