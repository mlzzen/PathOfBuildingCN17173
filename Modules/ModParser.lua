...
local modNameList = {
	...
	["物理持续伤害效果"] = {"ColdDamage", KeywordFlag.ColdDot},
	...
	["物理持续伤害效果"] = {"PhysicalDamage", KeywordFlag.PhysicalDot},
	...
	["攻击和法术格挡率上限"] = { "BlockChanceMax", "SpellBlockChanceMax" },
	...
	["你技能的光环在你身上的效果"] = "AuraEffectOnSelf", --备注：effect of auras on you
	...
	["你被冰冻的持续时间"] = "SelfFreezeDuration", --备注：freeze duration
	...
	["的移动速度"] = "MovementSpeed", --备注：movement speed
	...
	["行动速度"] = "ActionSpeed", --备注：action speed
...
local preFlagList = {
	...
	["周围每个灵枢都使你"] = { tag = { type = "Multiplier", var = "NearbyCorpse"} },
}
...
local modTagList = {
	...
	["每 (%d+) 敏捷"] = function(num) return { tag = { type = "PerStat", stat = "Dex", div = num } } end, 
	...
	["获得灵巧"] = { tag = { type = "Condition", varList = { "CanBeElusive", "Elusive" } } },
	...
	["你若至少有 (%d+) 点力量，则"] = function(num) return { tag = { type = "StatThreshold", stat = "Str", threshold = num } } end, --备注：w?h?i[lf]e? you have at least (%d+) strength
	...
	["近期内你若格挡过攻击伤害，"] = { tag = { type = "Condition", var = "BlockedAttackRecently" } }, --备注：if you[' ]h?a?ve blocked an attack recently
	...
	["被诅咒怪物"] = { tag = { type = "ActorCondition", actor = "enemy", var = "Cursed" } }, --备注：against cursed enemies
...
local specialModList = {
	...
	["此物品上装备的非【瓦尔技能石】等级 %-(%d+)"] = function(num) return { mod("GemProperty", "LIST", {
		keyword = "non-vaal", key = "level", value = -1 * tonumber(num) }, { type = "SocketedIn", slotName = "{SlotName}" }) } end,
	...
	["所有([^\\x00-\\xff]*)技能石等级 %+(%d+)"] = function( _, type_Cn,num) return { mod("GemProperty", "LIST", {
	keywordList =  {"active_skill",  type_Cn
	:gsub("效果区域","aoe")
	:gsub("物理法术","physical_spell")
	:gsub("混沌法术","chaos_spell")
	:gsub("敏捷","dexterity")
	:gsub("智慧","intelligence")
	:gsub("力量","strength")
	:gsub("光环","aura")
	:gsub("绿色","dexterity")
	:gsub("智慧","intelligence")
	...
	["每秒再生 ([%d%.]+) 生命"] = function(num) return {  mod("LifeRegen", "BASE", num)  } end,
	["低血时每秒回复 ([%d%.]+) 生命"] = function(num) return { mod("LifeRegen", "BASE", num, { type = "Condition", var = "LowLife" }) } end,
	...
	["(.+)的总魔力保留额外降低 (%d+)%%"]= function(_, skill_name, num) return {  mod("ManaReserved", "MORE", -num,{ type = "SkillName", skillName =  FuckSkillActivityCnName(skill_name)})  } end,
	["(.+)的总魔力保留效能额外提高 (%d+)%%"]= function(_, skill_name, num) return {  mod("ManaReservationEfficiency", "MORE", tonumber(num),{ type = "SkillName", skillName =  FuckSkillActivityCnName(skill_name)})  } end,
	...
	["生命每秒再生 ([%d%.]+)"] = function(num) return {  mod("LifeRegen", "BASE", num)  } end,
	...
	["捷技能的魔力保留效能提高 ([%d%.]+)%%"] = function(num) return { mod("ManaReservationEfficiency", "INC", num, { type = "SkillType", skillType = SkillType.Herald}) } end,
	...
	["召唤生物拥有不洁之力"] = {mod("MinionModifier", "LIST", { mod = flag("UnholyMight", {addToMinion = true}) })},
	...
	["攻击伤害在受精准影响时提高 (%d+)%%"]= function(num) return {  mod("Damage", "INC", num, nil, ModFlag.Attack, { type = "Condition", var = "AffectedBy精准" })  } end,
	["物理伤害在使用骄傲时提高 (%d+)%%"]= function(num) return {  mod("PhysicalDamage", "INC", num, { type = "Condition", var = "AffectedBy尊严" })  } end,
	...
	["伤害在受愤怒影响时穿透 (%d+)%% 火焰抗性"] = function(num) return {  mod("ElementalPenetration", "BASE", num,{ type = "Condition", var = "AffectedBy愤怒" })  } end,
	...
	["被清晰影响时，非吟唱技能的总魔力消耗 %-(%d+)"]= function(num) return { mod("ManaCost", "BASE", -num, { type = "SkillType", skillType = SkillType.Channel, neg = true }, { type = "Condition", var = "AffectedBy清晰" })  } end,
	...
	["受到【纪律】影响时，每秒回复 ([%d%.]+)%% 能量护盾"]= function(num) return {  mod("EnergyShieldRegenPercent", "BASE", num,{ type = "Condition", var = "AffectedBy纪律" })  } end,
	["受到【纪律】影响时，能量护盾提早 (%d+)%% 开始恢复"]= function(num) return {  mod("EnergyShieldRechargeFaster", "INC", num,{ type = "Condition", var = "AffectedBy纪律" })  } end,
	["受到【纪律】影响时，%+(%d+)%% 的几率格挡法术伤害"]= function(num) return { mod("SpellBlockChance", "BASE", num,{ type = "Condition", var = "AffectedBy纪律" }) } end,
	...
	["受到【优雅】影响时，%+(%d+)%% 闪避攻击击中率"]= function(num) return {  mod("EvadeChance", "BASE", num,{ type = "Condition", var = "AffectedBy优雅" })  } end,
	["法术伤害压制率在受到优雅影响时 %+(%d+)%%"]= function(num) return {  mod("SpellSuppressionChance", "BASE", num,{ type = "Condition", var = "AffectedBy优雅" })  } end,
	["法术伤害压制率在受到迅捷影响时 %+(%d+)%%"]= function(num) return {  mod("SpellSuppressionChance", "BASE", num,{ type = "Condition", var = "AffectedBy迅捷" })  } end,
	["受到【迅捷】影响时获得【迷踪】状态"]= { flag("Condition:Phasing", { type = "Condition", var = "AffectedBy迅捷" }) },
	["受到迅捷光环影响时，行动速度加快(%d+)%%"]= function(num) return { mod("ActionSpeed", "INC", num, { type = "Condition", var = "AffectedBy迅捷" }) } end,
	...
	["受到元素净化光环影响时，所有元素抗性上限提高%+(%d+)%%"] = function(num) return { 
		mod("FireResistMax", "BASE", tonumber(num), { type = "Condition", var = "AffectedBy元素净化" }),
		mod("ColdResistMax", "BASE", tonumber(num), { type = "Condition", var = "AffectedBy元素净化" }),
		mod("LightningResistMax", "BASE", tonumber(num), { type = "Condition", var = "AffectedBy元素净化" }),
	} end,
	["受到【火焰净化】影响时，受到击中物理伤害的 (%d+)%% 转换为火焰伤害"]= function(num) return {  mod("PhysicalDamageTakenAsFire", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy火焰净化" })  } end,
		["受到击中冰霜伤害的 (%d+)%% 转为火焰伤害"] = function(num) return {  mod("ColdDamageTakenAsFire", "BASE", num)  } end,
	["受到火焰净化影响时，受到的冰霜和闪电伤害的(%d+)%%视为火焰伤害"]= function(num) return { 
		mod("ColdDamageTakenAsFire", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy火焰净化" }),
		mod("LightningDamageTakenAsFire", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy火焰净化" }),
	} end,
	...
	["受到冰霜净化影响时，受到的火焰和闪电伤害的(%d+)%%视为冰霜伤害"]= function(num) return { 
		mod("FireDamageTakenAsCold", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy冰霜净化" }),
		mod("LightningDamageTakenAsCold", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy冰霜净化" }),
	} end,
	...
	["受到闪电净化影响时，受到的火焰和冰霜伤害的(%d+)%%视为闪电伤害"]= function(num) return { 
		mod("FireDamageTakenAsLightning", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy闪电净化" }),
		mod("ColdDamageTakenAsLightning", "BASE", tonumber(num),{ type = "Condition", var = "AffectedBy闪电净化" }),
	} end,
	...
	["在奋锐光环影响下，偷取的每秒最大能量护盾总恢复量提高 (%d+)%%"]= function(num) return {  mod("MaxEnergyShieldLeechRate", "INC", tonumber(num),{ type = "Condition", var = "AffectedBy奋锐光环" })  } end,
	["受到奋锐光环影响时不受诅咒影响"] = { mod("CurseEffectOnSelf", "MORE", -100, { type = "Condition", var = "AffectedBy奋锐光环" }) },
	...
	["该武器的攻击穿透 (%d+)%% 的闪电抗性"]= function(num) return {  mod("LightningPenetration", "BASE", num,{ type = "Condition", var = "{Hand}Attack" } )  } end,
	["该武器的攻击穿透 (%d+)%% 的火焰抗性"]= function(num) return {  mod("FirePenetration", "BASE", num,{ type = "Condition", var = "{Hand}Attack" } )  } end,
	["该武器的攻击穿透 (%d+)%% 的冰霜抗性"]= function(num) return {  mod("ColdPenetration", "BASE", num,{ type = "Condition", var = "{Hand}Attack" } )  } end,
	["该武器的攻击穿透 (%d+)%% 的元素抗性"]= function(num) return {  mod("ElementalPenetration", "BASE", num,{ type = "Condition", var = "{Hand}Attack" } )  } end,
	["该武器的攻击穿透 (%d+)%% 的混沌抗性"]= function(num) return {  mod("ChaosPenetration", "BASE", num,{ type = "Condition", var = "{Hand}Attack" } )  } end,
	...
	["【([^\\x00-\\xff]*)】提供的召唤生物攻击速度提高 (%d+)%%"]= function(_,skill_name,num) return { mod("ExtraSkillMod", "LIST", { mod = mod("Speed", "INC", tonumber(num),nil,ModFlag.Attack,{ type = "GlobalEffect", effectType = "Buff" }) },{ type = "SkillName", skillName =FuckSkillActivityCnName(skill_name) })  } end,
	...
	["使用尊严时，攻击击中时有 (%d+)%% 几率穿刺敌人"]= function(num) return { mod("ImpaleChance", "BASE", num, 0, 0, KeywordFlag.Attack,{ type = "Condition", var = "AffectedBy尊严" }) } end,
	["使用尊严时有 (%d+)%% 的几率造成双倍伤害"] = function(num) return { mod("DoubleDamageChance", "BASE", num,{ type = "Condition", var = "AffectedBy尊严" }) } end,
	["使用尊严时，攻击击中时有 (%d+)%% 的几率穿刺敌人"]= function(num) return { mod("ImpaleChance", "BASE", num, 0, 0, KeywordFlag.Attack,{ type = "Condition", var = "AffectedBy尊严" }) } end,
	...
	["使用【尊严】时，攻击击中有 (%d+)%% 几率穿刺敌人"]= function(num) return { mod("ImpaleChance", "BASE", num, 0, 0, KeywordFlag.Attack,{ type = "Condition", var = "AffectedBy尊严" }) } end,
	["使用【尊严】时有 (%d+)%% 的几率造成双倍伤害"] = function(num) return { mod("DoubleDamageChance", "BASE", num,{ type = "Condition", var = "AffectedBy尊严" }) } end,
	["使用【尊严】时，攻击击中有 (%d+)%% 的几率穿刺敌人"]= function(num) return { mod("ImpaleChance", "BASE", num, 0, 0, KeywordFlag.Attack,{ type = "Condition", var = "AffectedBy尊严" }) } end,
	...
	["该武器击中后造成的 (%d+)%% 物理伤害转换为一种随机元素伤害"]= function(num) return {mod("PhysicalDamageGainAsRandom", "BASE", tonumber(num), nil, ModFlag.Weapon)} end,
	["获得等同武器物理伤害 (%d+)%% 的随机一种额外火焰，冰霜，或者闪电伤害"]= function(num) return { mod("PhysicalDamageGainAsRandom", "BASE", tonumber(num), nil, ModFlag.Weapon)} end,
	["获得等同 (%d+)%% 物理伤害的 1 个随机火焰、冰霜、闪电伤害"]= function(num) return { mod("PhysicalDamageGainAsRandom", "BASE", tonumber(num))} end,
	["获得等同 (%d+)%% 物理伤害的 1 个随机元素伤害"]= function(num) return { mod("PhysicalDamageGainAsRandom", "BASE", tonumber(num))} end,
	...
	["投射物的伤害随着飞行距离提升，%s*击中目标时最多提高 (%d+)%%"] = function(num) return { mod("Damage", "INC", num, nil, bor(ModFlag.Hit, ModFlag.Projectile), { type = "DistanceRamp", ramp = { {35,0},{70,1} } }) } end,
	...
	["若你近期内用双手近战武器造成暴击，则有 (%d+)%% 的几率造成双倍伤害"] = function(num) return { mod("DoubleDamageChance", "BASE", num, { flags = bor(ModFlag.Weapon2H, ModFlag.WeaponMelee), type = "Condition", var = "CritRecently" }) } end,
	...
	["专注时有 (%d+)%% 的几率伤害翻倍"] = function(num) return { mod("DoubleDamageChance", "BASE", num,{ type = "Condition", var = "Focused" }) } end,
	...
	["对抗传奇敌人时，击中和异常状态伤害提高 (%d+)%%"] = function(num) return { mod("Damage", "INC", num,nil,0,bor(KeywordFlag.Hit, KeywordFlag.Ailment) ,{ type = "ActorCondition", actor = "enemy", var = "RareOrUnique" }) } end,
	...
	["只影响小圈内的天赋"] = { mod("JewelData", "LIST", { key = "radiusIndex", value = 4 }) },
	["只影响中圈内的天赋"] = { mod("JewelData", "LIST", { key = "radiusIndex", value = 5 }) },
	...
	["每个绿色插槽使召唤生物 (%d+)%% 的物理伤害转化为冰霜伤害"] = function(num) return { 
		mod("MinionModifier", "LIST", { mod = mod("PhysicalDamageConvertToCold", "BASE", num) }, { type = "Multiplier", var = "GreenSocketIn{SlotName}" }) 
	} end,
	...
	["召唤生物 (%d+)%% 的物理伤害转化为冰霜伤害"] = function(num) return { 
		mod("MinionModifier", "LIST", { mod = mod("PhysicalDamageConvertToCold", "BASE", num) }) 
	} end,
	...
	["禁用除(.+)之外的其他光环技能"] = function(_, name) return {
	...
	["受到你诅咒的敌人承受的伤害提高 (%d+)%%"] = function(num) return { mod("EnemyModifier", "LIST", { mod = mod("DamageTaken", "INC", num) }, {type = "ActorCondition", actor = "enemy", var = "Cursed"}) } end,
	...
	["受到的混沌伤害的(%d+)%%穿透能量护盾"] = function(num) return {
	...
	mod("秘术增强Effect", "INC", tonumber(num2),
	{ type = "Multiplier", var = "ManaSpentRecently", div = tonumber(num1) , limit = tonumber(num3), limitTotal = true}) } end,
	["受到清晰光环影响时，你的秘术增强效果提高(%d+)%%"] = function(num) return { mod("秘术增强Effect", "INC", tonumber(num2),{ type = "Condition", varList = { "AffectedBy清晰"} }) } end,
	...
	["周围每个灵枢都使你每秒再生 ([%d%.]+)%% 生命，最多 ([%d%.]+)%%"] = function(num, _, limit) return {
		mod("LifeRegenPercent", "BASE", num,{ type = "Multiplier", var = "NearbyCorpse", limit = tonumber(limit), limitTotal = true })
	} end,
	["周围每个灵枢都使你每秒再生 ([%d%.]+) 生命"] = function(num) return {
		mod("LifeRegen", "BASE", num, { type = "Multiplier", var = "NearbyCorpse" })
	} end,
	...
	["周围敌人致盲"] = { mod("EnemyModifier", "LIST", { mod = flag("Condition:Blinded")} )},
	...
	["受到的混沌伤害的(%d+)%%无法穿透能量护盾"] = function(num) return { mod("ChaosEnergyShieldBypass", "BASE", -num) } end,
	["非低血状态时不造成伤害"] = {
	...
	["你技能的光环只能影响你"] = { flag("SelfAurasCannotAffectAllies") },
	...
	["弓攻击终结"] = { mod("CullPercent", "MAX", 10, nil, bor(ModFlag.Bow, ModFlag.Hit)) },
	...
	["插入的技能石消耗等同于魔力消耗 (%d+)%% 的生命"] = function(num) return { 
	...
	["光环技能的魔力保留总增 (%d+)%%"]= function(num) return {  mod("ManaReserved", "MORE", num, { type = "SkillType", skillType = SkillType.Aura })  } end,
	...
	["光环技能的光环效果按照它们每保留 (%d+)%% 魔力上限就总增 (%d+)%%"] = function(num1, _, num2) return { mod("Reserved", "MORE", num2, { type = "PerStat", stat = "ManaReservedPercent", div = num1 }) } end,
	----消耗
	...
	["元素伤害击中时移除该种元素曝露，并施加其它元素曝露 通过这种方式施加的元素曝露使其抗性 (%-%d+)%%"] = function(num) return {
		flag("ElementalEquilibrium"),
	...
	["每 (%d+) 秒触发 (%d+) 级的【(.+)】、【(.+)】或【(.+)】"] = function(num1, _, num2, skill1, skill2, skill3) return {
		mod("ExtraSkill", "LIST", { skillId = gemIdLookup[skill1], level = num2, triggered = true }),
		mod("ExtraSkill", "LIST", { skillId = gemIdLookup[skill2], level = num2, triggered = true }),
		mod("ExtraSkill", "LIST", { skillId = gemIdLookup[skill3], level = num2, triggered = true }),
	} end,
	...
	["受到精准光环影响时，暴击率提高(%d+)%%"] = function(num) return { mod("CritChance", "INC", num, { type = "Condition", var = "AffectedBy精准" }) } end,
	-- Generic Ailments
	...
	["受到愤怒光环影响时始终造成烧灼"] = { mod("EnemyScorchChance", "BASE", 100, { type = "Condition", var = "AffectedBy愤怒" }) },
	["受到憎恨光环影响时始终造成脆弱"] = {	mod("EnemyBrittleChance", "BASE", 100, { type = "Condition", var = "AffectedBy憎恨" })	},
	["受到雷霆光环影响时始终造成精疲力尽"] = { mod("EnemySapChance", "BASE", 100, { type = "Condition", var = "AffectedBy雷霆" }) },
	-- Bleed
	...
	["低血时获得暗影迷踪"] = { flag("Condition:Phasing", { type = "Condition", var = "LowLife" })},
	["低血时获得灵巧"] = { flag("Condition:CanBeElusive", { type = "Condition", var = "LowLife" })},
	...
	["你可以额外施加一个诅咒"] = { mod("EnemyCurseLimit", "BASE", 1) }, --备注：enemies can have 1 additional curse
	["受到怨毒光环影响时，你可以额外施加一个诅咒"] = { mod("EnemyCurseLimit", "BASE", 1, { type = "Condition", var = "AffectedBy怨毒光环" }) }, --备注：enemies can have 1 additional curse
	["对受诅咒敌人造成腐烂，每秒 (%d+) 点混沌伤害，持续 %d+ 秒"] = function(num) return {
	...
	["负面效果持续时间缩短速度提高 (%d+)%%"] = function(num) return { mod("SelfDebuffExpirationRate", "BASE", num)} end,
	...
	-- Jewels
	["(.+)范围内的天赋可以在未连结至天赋树的情况下配置"] = function(_, name) return {
	...
	["(.+)的诅咒效果提高 ([%d%.]+)%%"] = function(_, skill_name, num) return { mod("CurseEffect", "INC",  tonumber(num), { type = "SkillName", skillName =  FuckSkillActivityCnName(skill_name)}) } end,
	["【(.+)】的诅咒效果提高 ([%d%.]+)%%"] = function(_, skill_name, num) return { mod("CurseEffect", "INC", tonumber(num), { type = "SkillName", skillName =  FuckSkillActivityCnName(skill_name)}) } end,
	...
	["力量按照配置的每个专精天赋 %+(%d+)"] = function(num) return { mod("Str", "BASE", num, { type = "Multiplier", var = "AllocatedMastery" }) } end,
	["敏捷按照配置的每个专精天赋 %+(%d+)"] = function(num) return { mod("Dex", "BASE", num, { type = "Multiplier", var = "AllocatedMastery" }) } end,
	["智慧按照配置的每个专精天赋 %+(%d+)"] = function(num) return { mod("Int", "BASE", num, { type = "Multiplier", var = "AllocatedMastery" }) } end,
	["分配给你的各类专精可增加(%d+)%%伤害"] = function(num) return { mod("Damage", "MORE", num, { type = "Multiplier", var = "AllocatedMasteryType" }) } end,
	...
	["召唤生物的攻击速度提高 (%d+)%%"] = function(num) return { mod("MinionModifier", "LIST", { mod = mod("Speed", "INC", num, nil, ModFlag.Attack ) }) } end,
	["至少有 400 点力量时，每秒回复 (%d+)%% 生命"] = function(num) return { mod("LifeRegenPercent", "BASE", num, { type = "StatThreshold", stat = "Str", threshold = 400 }) } end,
	["至少有 200 点力量时，(%d+)%% 几率造成双倍伤害"] = function(num) return { mod("DoubleDamageChance", "BASE", num, { type = "StatThreshold", stat = "Str", threshold = 200 }) } end,
	["至少有 400 点力量时，(%d+)%% 几率造成三倍伤害"] = function(num) return { mod("TripleDamageChance", "BASE", num, { type = "StatThreshold", stat = "Str", threshold = 400 }) } end,
	["你身上的减益效果消失速度提高 (%d+)%%"] = {},
...
local jewelThresholdFuncs = {
	...
	["若范围内含有 40 点敏捷，则【流星射击】的范围效果扩大 25%"] = getThreshold("Dex", "AreaOfEffect", "INC", 25, { type = "SkillName", skillName = "流星射击" }), --备注：With at least 40 Dexterity in Radius, Shrapnel Shot has 25% increased Area of Effect
