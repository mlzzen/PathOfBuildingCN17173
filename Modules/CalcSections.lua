...
{ 3, "HitDamage", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "技能击中伤害", data = {
	...
	{ label = "命中率", haveOutput = "enemyHasSpellBlock", { format = "{0:output:HitChance}%",
		{ breakdown = "HitChance" }, 
		{ label = "Enemy Block", modName = { "BlockChance" }, enemy = true },
	}, },
	{ label = "平均伤害", haveOutput = "enemyHasSpellBlock", { format = "{1:output:AverageDamage}", 
		{ breakdown = "AverageDamage" },
	}, },
...
{ 1, "Crit", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "暴击", data = {
	...
	{ label = "主手暴击几率", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", { format = "{2:output:MainHand.CritChance}%", 
		...
		{ label = "玩家加成", modName = { "CritChance", "WeaponBaseCritChance" }, cfg = "weapon1" }, 
		{ label = "敌人加成", modName = "SelfCritChance", enemy = true }, 
	}, },
	...
	{ label = "副手暴击几率", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", { format = "{2:output:OffHand.CritChance}%", 
		...
		{ label = "玩家加成", modName = { "CritChance", "WeaponBaseCritChance" }, cfg = "weapon2" },
		{ label = "敌人加成", modName = "SelfCritChance", enemy = true }, 
	}, },
...
{ 1, "穿刺", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "穿刺", data = {
	...
	{ label = "暴击时穿刺几率", bgCol = colorCodes.MAINHANDBG, flag = "spell", haveOutput = "ImpaleChanceOnCrit", { format = "{0:output:ImpaleChanceOnCrit}%",
...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "技能类型-特殊状态", data = {
	...
	{ label = "魔力每秒百分比消耗", color = colorCodes.MANA, haveOutput = "ManaPercentPerSecondHasCost", { format = "{2:output:ManaPercentPerSecondCost}", { breakdown = "ManaPercentPerSecondCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	...
	{ label = "生命每秒消耗", color = colorCodes.LIFE, haveOutput = "LifePerSecondHasCost", { format = "{2:output:LifePerSecondCost}", { breakdown = "LifePerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命每秒百分比消耗", color = colorCodes.LIFE, haveOutput = "LifePercentPerSecondHasCost", { format = "{2:output:LifePercentPerSecondCost}", { breakdown = "LifePercentPerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	...
	{ label = "能量护盾每秒消耗", color = colorCodes.ES, haveOutput = "ESPerSecondHasCost", { format = "{2:output:ESPerSecondCost}", { breakdown = "ESPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "能量护盾每秒百分比消耗", color = colorCodes.ES, haveOutput = "ESPercentPerSecondHasCost", { format = "{2:output:ESPercentPerSecondCost}", { breakdown = "ESPercentPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	...
	{ label = "怒火每秒消耗", color = colorCodes.RAGE, haveOutput = "RagePerSecondHasCost", { format = "{2:output:RagePerSecondCost}", { breakdown = "RagePerSecondCost" }, { modName = { "RageCost", "Cost" }, cfg = "skill" }, }, },
	...
	{ label = "魔力保留持续时间", haveOutput = "ReserveDuration", { format = "{3:output:ReserveDuration}s", { breakdown = "ReserveDuration" }, }, },{ label = "Uptime", haveOutput = "DurationUptime", { format = "{2:output:DurationUptime}%", { breakdown = "DurationUptime" }, }, },
	...
	{ label = "穿透数量", haveOutput = "PierceCount", { format = "{output:PierceCountString}", { modName = { "CannotPierce", "PierceCount", "PierceAllTargets" }, cfg = "skill" }, }, },
	{ label = "分裂数量", haveOutput = "ForkCountMax", { format = "{output:ForkCountString}", { modName = { "CannotFork", "ForkCountMax" }, cfg = "skill" }, }, },
	{ label = "最大连锁数量", haveOutput = "ChainCountMax", { format = "{output:ChainMaxString}", { modName = { "CannotChain", "ChainCountMax" }, cfg = "skill" }, }, }, 
	...
	{ label = "技能自伤(禁断典仪)", haveOutput = "FRDamageTaken", { format = "{output:FRDamageTaken}", { breakdown = "FRDamageTaken" },{ modName = { "DamageTaken", "DamageTakenWhenHit", "ChaosDamageTaken", "ChaosDamageTakenWhenHit" } } }, },
	{ label = "技能自伤(七伤破)", haveOutput = "BSDamageTaken", { format = "{0:output:BSDamageTaken}", { breakdown = "BSDamageTaken" },{ modName = { "DamageTaken", "DamageTakenWhenHit"} } }, },	
	...
	{ label = "小爆炸次数", haveOutput = "SmallExplosionsPerTrap", { format = "{0:output:SmallExplosionsPerTrap}", 
		{ label = "小爆炸次数", modName = "SmallExplosions", cfg = "skill" },
	}, },
	{ label = "陷阱平均激活数量", haveOutput = "AverageActiveTraps", { format = "{2:output:AverageActiveTraps}", { breakdown = "AverageActiveTraps" }, }, },
	...
	{ label = "陷阱投掷速度", flag = "trap", { format = "{2:output:TrapThrowingSpeed}",
	...
	{ label = "图腾能量护盾", haveOutput = "TotemEnergyShield", { format = "{0:output:TotemEnergyShield}", 
		{ breakdown = "TotemEnergyShield" },
		{ modName = "TotemEnergyShield", cfg = "skill" },
	}, },
	{ label = "图腾格挡几率", haveOutput = "TotemBlockChance", { format = "{0:output:TotemBlockChance}%", 
		{ breakdown = "TotemBlockChance" },
		{ modName = "TotemBlockChance", cfg = "skill" },
	}, },
	{ label = "图腾护甲", haveOutput = "TotemArmour", { format = "{0:output:TotemArmour}", 
...
{ 1, "击中几率", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "命中率", data = {
	...
	{ label = "主手击中几率", haveOutput = "MainHand.enemyBlockChance", bgCol = colorCodes.MAINHANDBG, flag = "weapon1Attack", { format = "{0:output:MainHand.HitChance}%",
		{ breakdown = "MainHand.HitChance" }, 
		{ label = "敌人闪避加成", modName = { "Evasion", "CannotEvade" }, enemy = true },
		{ label = "敌人格挡几率", modName = { "BlockChance" }, enemy = true },
		{ label = "玩家加成", modName = { "HitChance", "CannotBeEvaded", "IgnoreBlindHitChance" } },
	}, },
	...
	{ label = "副手击中几率", haveOutput = "OffHand.enemyBlockChance", bgCol = colorCodes.OFFHANDBG, flag = "weapon2Attack", { format = "{0:output:OffHand.HitChance}%",
		{ breakdown = "OffHand.HitChance" },
		{ label = "敌人闪避加成", modName = { "Evasion", "CannotEvade" }, enemy = true },
		{ label = "敌人格挡几率", modName = { "BlockChance" }, enemy = true },
		{ label = "玩家加成", modName = { "HitChance", "CannotBeEvaded", "IgnoreBlindHitChance" } },
...
{ 1, "Bleed", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "流血", data = {
	...
	{ label = "流血持续时间", { format = "{2:output:BleedDuration}s", 
		...
		{ label = "玩家加成", modName = { "EnemyBleedDuration", "EnemyAilmentDuration", "SkillAndDamagingAilmentDuration", "BleedFaster" }, cfg = "bleed" }, 
		{ label = "敌人加成", modName = { "SelfBleedDuration", "SelfAilmentDuration", "SelfBleedFaster", "BleedExpireRate" }, enemy = true },
	}, },
} }
} },
{ 1, "Poison", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "中毒", data = {
	...
	{ label = "等效持续伤害加成", notFlag = "attack", haveOutput = "PoisonDotMulti", { format = "x {2:output:PoisonDotMulti}", { breakdown = "PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier" }, modType = "BASE", cfg = "poison" }, }, },
	...
	{ label = "中毒持续时间", { format = "{2:output:PoisonDuration}s", 
		...
		{ label = "玩家加成", modName = { "EnemyPoisonDuration", "EnemyAilmentDuration", "SkillAndDamagingAilmentDuration", "PoisonFaster" }, cfg = "poison" },
		{ label = "敌人加成", modName = { "SelfPoisonDuration", "SelfAilmentDuration", "SelfPoisonFaster" }, enemy = true },
	}, },
	...
	{ flag = "notAverage", label = "最大中毒层数", { format = "{1:output:TotalPoisonStacks}",
		...
		{ label = "上限 1 层", modName = "Condition:SinglePoison" }, 
	}, },
} }
} },
...
{ 1, "Ignite", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "点燃", data = {	
	...
	{ label = "点燃持续时间", { format = "{2:output:IgniteDuration}s", 
		...
		{ label = "玩家加成", modName = { "EnemyIgniteDuration", "EnemyAilmentDuration", "EnemyElementalAilmentDuration", "SkillAndDamagingAilmentDuration", "IgniteBurnFaster", "IgniteBurnSlower" }, cfg = "skill" },
		{ label = "敌人加成", modName = {"SelfIgniteDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "SelfIgniteBurnFaster"}, enemy = true },
	}, },
...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "非伤害异常状态", data = {
	...
	{ label = "冰缓持续时间", bgCol = colorCodes.CHILLBG, flag = "chill", { format = "{2:output:ChillDuration}s",
		...
		{ label = "玩家加成", modName = { "EnemyChillDuration", "EnemyAilmentDuration", "EnemyElementalAilmentDuration" }, cfg = "skill" },
		{ label = "敌人加成", modName = { "SelfChillDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "冰冻持续时间", bgCol = colorCodes.FREEZEBG, flag = "freeze", { format = "x {2:output:FreezeDurationMod}",
		...
		{ breakdown = "FreezeDPS" },
		{ label = "玩家加成", modName = { "EnemyFreezeDuration", "EnemyAilmentDuration", "EnemyElementalAilmentDuration", "FreezeAsThoughDealing" }, cfg = "skill" },
		{ label = "敌人加成", modName = { "SelfFreezeDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "脆弱持续时间", bgCol = colorCodes.BRITTLEBG, flag = "brittle", { format = "{2:output:BrittleDuration}s",
		...
		{ label = "玩家加成", modName = { "EnemyBrittleDuration", "EnemyAilmentDuration", "EnemyElementalAilmentDuration" }, cfg = "skill" },
		{ label = "敌人加成", modName = { "SelfBrittleDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "感电持续时间", bgCol = colorCodes.SHOCKBG, flag = "shock", { format = "{2:output:ShockDuration}s",
		...
		{ label = "玩家加成", modName = { "EnemyShockDuration", "EnemyAilmentDuration", "EnemyElementalAilmentDuration" }, cfg = "skill" },
		{ label = "敌人加成", modName = { "SelfShockDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true },
	}, },
	...
	{ label = "精疲力尽持续时间", bgCol = colorCodes.SAPBG, flag = "sap", { format = "{2:output:SapDuration}s",
		...
		{ label = "玩家加成", modName = { "EnemySapDuration", "EnemyAilmentDuration", "EnemyElementalAilmentDuration" }, cfg = "skill" },
		{ label = "敌人加成", modName = { "SelfSapDuration", "SelfAilmentDuration", "SelfElementalAilmentDuration", "BuffExpireFaster" }, enemy = true },
	}, },
...
{ 1, "Life", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "生命", data = {
	...
	{ label = "回复提高", { format = "{0:output:LifeRegenInc}%", { modName = "LifeRegen", modType = "INC" }, }, },
	{ label = "回复", { format = "{1:output:LifeRegenRecovery} ({1:output:LifeRegenPercent}%)", 
		...
		{ label = "额外提高", modName = { "LifeRegen" }, modType = "MORE" },
...
{ 1, "Mana", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "魔力", data = {
	...
	{ label = "回复", { format = "{1:output:ManaRegenRecovery} ({1:output:ManaRegenPercent}%)", 
		{ breakdown = "ManaRegenRecovery" }, 
		{ label = "源", modName = { "ManaRegen", "ManaRegenPercent", "ManaDegen", "ManaDegenPercent", "ManaRecovery" }, modType = "BASE" },
		{ label = "提高", modName = { "ManaRegen" }, modType = "INC" },
		{ label = "额外提高", modName = { "ManaRegen" }, modType = "MORE" },
...
{ 1, "EnergyShield", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "能量护盾", data = {
	...
	{ label = "回复提高", { format = "{0:output:EnergyShieldRegenInc}%", { modName = "EnergyShieldRegen", modType = "INC" }, }, },
	{ label = "回复", { format = "{1:output:EnergyShieldRegenRecovery} ({1:output:EnergyShieldRegenPercent}%)", 
		{ breakdown = "EnergyShieldRegenRecovery" }, 
		{ label = "源", modName = { "EnergyShieldRegen", "EnergyShieldRegenPercent", "EnergyShieldDegen", "EnergyShieldDegenPercent", "EnergyShieldRecovery" }, modType = "BASE" },
		{ label = "提高", modName = { "EnergyShieldRegen" }, modType = "INC" },
		{ label = "额外提高", modName = { "EnergyShieldRegen" }, modType = "MORE" },
...
{ 1, "Rage", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "怒火", data = {
	extra = "{0:output:Rage}",
	{ label = "总", { format = "{0:output:Rage}", }, },
	{ label = "最大怒火", { format = "{0:output:MaximumRage}", { modName = "MaximumRage", modType = "BASE" }, }, },
	{ label = "回复提高", { format = "{0:output:RageRegenInc}%", { modName = "RageRegen", modType = "INC" }, }, },
	{ label = "回复", { format = "{1:output:RageRegenRecovery} ({1:output:RageRegenPercent}%)", 
		{ breakdown = "RageRegenRecovery" }, 
		{ label = "源", modName = { "RageRegen", "RageRegenPercent", "RageDegen", "RageDegenPercent", "RageRecovery" }, modType = "BASE" },
		{ label = "提高", modName = { "RageRegen" }, modType = "INC" },
		{ label = "额外提高", modName = { "RageRegen" }, modType = "MORE" },
		{ label = "回复加成", modName = "RageRecoveryRate" },
	}, },
} }
} },
...
{ 1, "MiscDefences", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "其他防御", data = {
	...
	{ label = "避免伤害几率", haveOutput = "AvoidAllDamageFromHitsChance", { format = "{0:output:AvoidAllDamageFromHitsChance}%", { modName = "AvoidAllDamageFromHitsChance" }, }, },
	...
	{ label = "避免感电几率", haveOutput = "ShockAvoidChance", { format = "{0:output:ShockAvoidChance}%", { modName = { "AvoidShock", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免冰冻几率", haveOutput = "FreezeAvoidChance", { format = "{0:output:FreezeAvoidChance}%", { modName = { "AvoidFreeze", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免冰缓几率", haveOutput = "ChillAvoidChance", { format = "{0:output:ChillAvoidChance}%", { modName = { "AvoidChill", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免点燃几率", haveOutput = "IgniteAvoidChance", { format = "{0:output:IgniteAvoidChance}%", { modName = { "AvoidIgnite", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免精疲力尽几率", haveOutput = "SapAvoidChance", { format = "{0:output:SapAvoidChance}%", { modName = { "AvoidSap", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免脆弱几率", haveOutput = "BrittleAvoidChance", { format = "{0:output:BrittleAvoidChance}%", { modName = { "AvoidBrittle", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免烧灼几率", haveOutput = "ScorchAvoidChance", { format = "{0:output:ScorchAvoidChance}%", { modName = { "AvoidScorch", "AvoidElementalAilments", "AvoidAilments" } }, }, },
	{ label = "避免流血几率", haveOutput = "BleedAvoidChance", { format = "{0:output:BleedAvoidChance}%", { modName = { "AvoidBleed", "AvoidAilments" } }, }, },
	{ label = "避免中毒几率", haveOutput = "PoisonAvoidChance", { format = "{0:output:PoisonAvoidChance}%", { modName = { "AvoidPoison", "AvoidAilments" } }, }, },
	{ label = "避免诅咒几率", haveOutput = "CurseAvoidChance", { format = "{0:output:CurseAvoidChance}%", { modName = "AvoidCurse" }, }, },
	...
	{ label = "冰冻时间", { format = "{1:output:SelfFreezeDuration}%", { modName = { "SelfFreezeDuration", "SelfDebuffExpirationRate", "SelfFreezeDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "冰缓时间", { format = "{1:output:SelfChillDuration}%", { modName = { "SelfChillDuration", "SelfDebuffExpirationRate", "SelfChillDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "感电时间", { format = "{1:output:SelfShockDuration}%", { modName = { "SelfShockDuration", "SelfDebuffExpirationRate", "SelfShockDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "点燃时间", { format = "{1:output:SelfIgniteDuration}%", { modName = { "SelfIgniteDuration", "SelfDebuffExpirationRate", "SelfIgniteDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "筋疲力尽时间", { format = "{1:output:SelfSapDuration}%", { modName = { "SelfSapDuration", "SelfDebuffExpirationRate", "SelfSapDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "脆弱时间", { format = "{1:output:SelfBrittleDuration}%", { modName = { "SelfBrittleDuration", "SelfDebuffExpirationRate", "SelfBrittleDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "烧灼时间", { format = "{1:output:SelfScorchDuration}%", { modName = { "SelfScorchDuration", "SelfDebuffExpirationRate", "SelfScorchDebuffExpirationRate", "SelfAilmentDuration", "SelfElementalAilmentDuration" }, }, }, },
	{ label = "流血时间", { format = "{1:output:SelfBleedDuration}%", { modName = { "SelfBleedDuration", "SelfDebuffExpirationRate", "SelfBleedDebuffExpirationRate", "SelfAilmentDuration" }, }, }, },
	{ label = "中毒时间", { format = "{1:output:SelfPoisonDuration}%", { modName = { "SelfPoisonDuration", "SelfDebuffExpirationRate", "SelfPoisonDebuffExpirationRate", "SelfAilmentDuration" }, }, }, },
	{ label = "冰冻效果", { format = "{1:output:SelfFreezeEffect}%", { modName = "SelfFreezeEffect" }, }, },
	...
	{ label = "点燃效果", { format = "{1:output:SelfIgniteEffect}%", { modName = "SelfIgniteEffect" }, }, },
	{ label = "筋疲力尽效果", { format = "{1:output:SelfSapEffect}%", { modName = "SelfSapEffect" }, }, },
	{ label = "脆弱效果", { format = "{1:output:SelfBrittleEffect}%", { modName = "SelfBrittleEffect" }, }, },
	{ label = "灼烧效果", { format = "{1:output:SelfScorchEffect}%", { modName = "SelfScorchEffect" }, }, },
	{ label = "流血效果", { format = "{1:output:SelfBleedEffect}%", { modName = "SelfBleedEffect" }, }, },
	{ label = "中毒效果", { format = "{1:output:SelfPoisonEffect}%", { modName = "SelfPoisonEffect" }, }, },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "承受伤害", data = {
	...
	{ label = "最大承受击中次数",{ format = "{2:output:NumberOfDamagingHits}", },
	}
...
} }, { defaultCollapsed = true, label = "持续承受和吸纳的伤害", data = {
	colWidth = 190,
	...
	{
		{ format = colorCodes.LIFE.."生命:" },
		{ format = colorCodes.MANA.."魔力:" },
		{ format = colorCodes.ES.."能量护盾:" },
	},
	{ label = "最大吸纳回复速率", haveOutput = "anyRecoup", 
		{ format = "{0:output:LifeRecoupRecoveryMax}",
			{ breakdown = "LifeRecoupRecoveryMax" },
			{ label = "源", modName = { "LifeRecoup", "PhysicalLifeRecoup", "LightningLifeRecoup", "ColdLifeRecoup", "FireLifeRecoup", "ChaosLifeRecoup" } },
			{ label = "回复加成", modName = "LifeRecoveryRate" },
			{ label = "更快吸纳", modName = "3SecondRecoup" },
	},
		...
		{ format = "{0:output:EnergyShieldRecoupRecoveryMax}",
			...
			{ label = "源", modName = { "EnergyShieldRecoup", "ElementalEnergyShieldRecoup" } },
			{ label = "回复加成", modName = "EnergyShieldRecoveryRate" },
			{ label = "更快吸纳", modName = "3SecondRecoup" },
		},
	},
	{ label = "平均吸纳回复速率", haveOutput = "anyRecoup", 
	...
	{ label = "最大持续承受伤害", haveOutput = "preventedLifeLossTotal", 
