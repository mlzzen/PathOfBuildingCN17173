...
{ label = "技能 DPS（触发）", flag = "triggered", { format = "{1:output:TotalDPS}", { breakdown = "TotalDPS" }, }, },
	{ label = "魔力消耗", haveOutput = "ManaCost", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命消耗", haveOutput = "LifeCost", { format = "{0:output:LifeCost}", { breakdown = "LifeCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "能量护盾消耗", haveOutput = "ESCost", { format = "{0:output:ESCost}", { breakdown = "ESCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "怒气消耗", haveOutput = "RageCost", { format = "{0:output:RageCost}", { breakdown = "RageCost" }, { modName = { "RageCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "魔力消耗百分比", haveOutput = "ManaPercentCost", { format = "{0:output:ManaPercentCost}", { breakdown = "ManaPercentCost" }, { modName = { "ManaPercentCost", "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命消耗百分比", haveOutput = "LifePercentCost", { format = "{0:output:LifePercentCost}", { breakdown = "LifePercentCost" }, { modName = { "LifePercentCost", "LifeCost", "Cost" }, cfg = "skill" }, }, },
...
{ label = "总【提高】施法速度", flag = "spell", notFlag = "triggered", { format = "{0:mod:1}%", { modName = "Speed", modType = "INC", cfg = "skill", }, }, },
	...
	{ label = "触发速率上限", flag = "triggered", notFlag = "focussed", { format = "{2:output:ActionTriggerRate}", { breakdown = "ActionTriggerRate" }, { modName = "CooldownRecovery", modType = "INC", cfg = "skill", }, }, },
	{ label = "触发速率上限", flagList = {"triggered", "focussed"}, { format = "{2:output:ActionTriggerRate}", { breakdown = "ActionTriggerRate" }, { modName = "FocusCooldownRecovery", modType = "INC", cfg = "skill", }, }, },
...
{ modName = "LifeReserved", cfg = "skill" },
}, },
...
{ label = "保留", { format = "{0:output:ManaReserved} ({0:output:ManaReservedPercent}%)", { breakdown = "ManaReserved" }, { modName = "ManaReserved", cfg = "skill" },
{ modName = "SupportManaMultiplier", cfg = "skill" },
}, },
...
{ label = "充能速率", { format = "{1:output:EnergyShieldRecharge}", 
...
{ 1, "Armour", 3,  colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "护甲", data = {
	...
	{ label = "双倍护甲几率", haveOutput = "DoubleArmourChance", { format = "{0:output:DoubleArmourChance}%", { modName = "DoubleArmourChance" }, }, },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "伤害承受", data = {
	...
	{ label = "近战几率", { format = "{0:output:MeleeNotHitChance}%", { breakdown = "MeleeNotHitChance" }, }, },
	{ label = "投射物几率", { format = "{0:output:ProjectileNotHitChance}%", { breakdown = "ProjectileNotHitChance" }, }, },
	{ label = "法术几率", { format = "{0:output:SpellNotHitChance}%", { breakdown = "SpellNotHitChance" }, }, },
...
{ label = "实际能量护盾回复", haveOutput = "NetEnergyShieldRegen", { format = "{1:output:NetEnergyShieldRegen}", { breakdown = "NetEnergyShieldRegen" }, }, },
...
{ 1, "Block", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "格挡", data = {
		...
		{ label = "格挡法术回复ES", { format = "{0:output:EnergyShieldOnSpellBlock}", { modName = "EnergyShieldOnSpellBlock" }, }, },
} }, 
} },
