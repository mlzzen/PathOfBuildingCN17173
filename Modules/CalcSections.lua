...
{ label = "平均伤害", flag = "attack", { format = "{1:output:AverageDamage}", 
	...
	{ label = "技能 DPS（触发）", flag = "triggered", { format = "{1:output:TotalDPS}", { breakdown = "TotalDPS" }, }, },
	{ label = "魔力消耗", color = colorCodes.MANA, haveOutput = "ManaCost", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命消耗", color = colorCodes.LIFE, haveOutput = "LifeCost", { format = "{0:output:LifeCost}", { breakdown = "LifeCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "能量护盾消耗", color = colorCodes.ES, haveOutput = "ESCost", { format = "{0:output:ESCost}", { breakdown = "ESCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "怒气消耗", color = colorCodes.RAGE, haveOutput = "RageCost", { format = "{0:output:RageCost}", { breakdown = "RageCost" }, { modName = { "RageCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "魔力消耗百分比", color = colorCodes.MANA, haveOutput = "ManaPercentCost", { format = "{0:output:ManaPercentCost}", { breakdown = "ManaPercentCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命消耗百分比", color = colorCodes.LIFE, haveOutput = "LifePercentCost", { format = "{0:output:LifePercentCost}", { breakdown = "LifePercentCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "魔力每秒消耗", color = colorCodes.MANA, haveOutput = "ManaPerSecondCost", { format = "{2:output:ManaPerSecondCost}/s", { breakdown = "ManaPerSecondCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命每秒消耗", color = colorCodes.LIFE, haveOutput = "LifePerSecondCost", { format = "{2:output:LifePerSecondCost}/s", { breakdown = "LifePerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "魔力每秒消耗百分比", color = colorCodes.MANA, haveOutput = "ManaPercentPerSecondCost", { format = "{2:output:ManaPercentPerSecondCost}/s", { breakdown = "ManaPercentPerSecondCost" }, { modName = { "ManaCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "生命每秒消耗百分比", color = colorCodes.LIFE, haveOutput = "LifePercentPerSecondCost", { format = "{2:output:LifePercentPerSecondCost}/s", { breakdown = "LifePercentPerSecondCost" }, { modName = { "LifeCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "能量护盾每秒消耗", color = colorCodes.ES, haveOutput = "ESPerSecondCost", { format = "{2:output:ESPerSecondCost}/s", { breakdown = "ESPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
	{ label = "能量护盾每秒消耗百分比", color = colorCodes.ES, haveOutput = "ESPercentPerSecondCost", { format = "{2:output:ESPercentPerSecondCost}/s", { breakdown = "ESPercentPerSecondCost" }, { modName = { "ESCost", "Cost" }, cfg = "skill" }, }, },
} }
...
{ 3, "战吼", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "战吼增助", data = {
	...
	colWidth = 114,
	{
		...
		{ label = "【将军之吼】", haveOutput = "GeneralsCryUpTimeRatio", 
		{ format = "{2:output:GeneralsCryEffect}", { breakdown = "GeneralsCryEffect"}, },
		{ format = "{2:output:GeneralsCryAvgDmg}", { breakdown = "GeneralsCryAvgDmg"}, },
		{ format = "{0:output:GeneralsCryUpTimeRatio}%", { breakdown = "GeneralsCryUpTimeRatio" }, },
		{ format = "所有攻击" },
		{ format = "{2:output:GeneralsCryMaxHitEffect}" },
	},
...
{ label = "持续伤害",
	...
	{ label = "技能持续伤害DPS", { format = "{1:output:TotalDot}", { breakdown = "TotalDot" }, }, },
...
{ label = "全局光环效果加成", haveOutput = "AuraEffectMod", { format = "x {2:output:AuraEffectMod}",
		{ breakdown = "AuraEffectMod" },		
		{ modName = "AuraEffect", cfg = "skill" },	
		
	}, },
{ label = "自身光环效果加成", haveOutput = "AuraEffectOnSelfMod", { format = "x {2:output:AuraEffectOnSelfMod}",
		{ breakdown = "AuraEffectOnSelfMod" },
		{ modName = "PurpHarbAuraBuffEffect", cfg = "skill" },
		{ modName = "AuraEffect", cfg = "skill" },
		{ modName = "AuraEffectOnSelf", cfg = "skill" },
	}, },	
...
{ label = "地雷放置速率", flag = "mine", { format = "{2:output:MineLayingSpeed}", 
...
{ label = "敌人流血层数", { format = "{0:output:BleedStacks}" }},
...
{ label = "有效持续伤害加成", { format = "x {2:output:BleedDotMulti}", { breakdown = "BleedDotMulti" }, { modName = { "DotMultiplier", "PhysicalDotMultiplier" }, modType = "BASE", cfg = "bleed" }, }, },
...
{ label = "有效 DPS 加成", flag = "effective", { format = "x {3:output:BleedEffMult}", { breakdown = "BleedEffMult" }, { label = "敌人加成", modName = { "DamageTaken", "DamageTakenOverTime", "PhysicalDamageTaken", "PhysicalDamageTakenOverTime", "PhysicalDamageReduction" }, enemy = true , cfg = "bleed"}, }, },
...
{ label = "敌人加成", modName = { "SelfBleedDuration", "SelfBleedFaster" }, enemy = true },
	}, },
} },
} },
...
{ label = "有效持续伤害加成", { format = "x {2:output:PoisonDotMulti}", { breakdown = "PoisonDotMulti" }, { modName = { "DotMultiplier", "ChaosDotMultiplier" }, modType = "BASE", cfg = "poison" }, }, },
...
{ label = "有效持续伤害加成", { format = "x {2:output:IgniteDotMulti}", { breakdown = "IgniteDotMulti" }, { modName = { "DotMultiplier", "FireDotMultiplier" }, modType = "BASE", cfg = "ignite" }, }, },
...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "元素异常", data = {
	{ label = "【烧灼】效果提高", haveOutput = "ScorchEffectMod", flag = "scorch", { format = "{0:output:ScorchEffectMod}%",
		{ label = "玩家加成", modName = "EnemyScorchEffect", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfScorchEffect", enemy = true },
	}, },
	{ label = "【烧灼】几率", haveOutput = "ScorchChance", flag = "scorch", { format = "{0:output:ScorchChance}%",
		...
		{ label = "烧灼覆盖值", modName = "ScorchOverride", modType = "BASE" },
	}, },
	{ label = "【烧灼】持续时间加成", haveOutput = "ScorchDurationMod", flag = "scorch", { format = "x {2:output:ScorchDurationMod}",
		{ label = "玩家加成", modName = "EnemyScorchDuration", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfScorchEffect", enemy = true },
	}, },
	{ label = "【冰缓】效果加成", flag = "chill", { format = "{0:output:ChillEffectModDisplay}%",
		{ label = "玩家加成", modName = "EnemyChillEffect", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfChillEffect", enemy = true },
	}, },
	{ label = "【冰缓】持续时间加成", flag = "chill", { format = "x {2:output:ChillDurationMod}",
		{ breakdown = "ChillDurationMod" },
		{ breakdown = "MainHand.ChillDPS" },
		{ breakdown = "OffHand.ChillDPS" },
		{ breakdown = "ChillDPS" },
		{ label = "玩家加成", modName = { "EnemyChillDuration", "ChillAsThoughDealing" }, cfg = "skill" },
		{ label = "敌人加成", modName =  { "SelfChillEffect", "SelfChillDuration" }, enemy = true },
	}, },
	{ label = "【冰冻】几率", flag = "freeze", { format = "{0:output:FreezeChance}%", 
	...
	{ label = "【冰冻】持续时间加成", flag = "freeze", { format = "x {2:output:FreezeDurationMod}", 
	...
	{ label = "【脆弱】效果提高", haveOutput = "BrittleEffectMod", flag = "brittle", { format = "{0:output:BrittleEffectMod}%",
		{ label = "玩家加成", modName = "EnemyBrittleEffect", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfBrittleEffect", enemy = true },
	}, },
	{ label = "【脆弱】几率", haveOutput = "BrittleChance", flag = "brittle", { format = "{0:output:BrittleChance}%",
	...
	{ label = "【脆弱】持续时间加成", haveOutput = "BrittleDurationMod", flag = "brittle", { format = "x {2:output:BrittleDurationMod}",
		{ label = "玩家加成", modName = "EnemyBrittleDuration", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfBrittleEffect", enemy = true },
	}, },
	{ label = "【感电】效果加成", flag = "shock", { format = "{0:output:ShockEffectModDisplay}%",
		{ label = "玩家加成", modName = "EnemyShockEffect", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfShockEffect", enemy = true },
	}, },
	{ label = "【感电】几率", flag = "shock", { format = "{0:output:ShockChance}%", 
		...
		{ label = "【感电】持续时间加成", flag = "shock", { format = "x {2:output:ShockDurationMod}", 
		{ breakdown = "ShockDurationMod" },
		{ breakdown = "MainHand.ShockDPS" },
		{ breakdown = "OffHand.ShockDPS" },
		{ breakdown = "ShockDPS" },
		{ label = "玩家加成", modName = { "EnemyShockDuration", "ShockAsThoughDealing" }, cfg = "skill" }, 
		{ label = "敌人加成", modName = "SelfShockDuration", enemy = true }, 
	}, },
		{ label = "感电效果上限", flag = "shock", { format = "{0:output:MaximumShock}%", 
		{ modName = "ShockMax" }, 
	}, },
		{ label = "当前的感电效果", haveOutput = "CurrentShock", { format = "{0:output:CurrentShock}%", 
		{ label = "配置的感电效果", modName = "ShockVal", enemy = true, modType = "BASE" }, 
		{ label = "保底感电效果", modName = "ShockOverride", modType = "BASE" },
	}, },
	{ label = "【精疲力尽】效果提高", haveOutput = "SapEffectMod", flag = "sap", { format = "{0:output:SapEffectMod}%",
		{ label = "玩家加成", modName = "EnemySapEffect", cfg = "skill" },
		{ label = "敌人加成", modName = "SelfSapEffect", enemy = true },
	}, },
	{ label = "【精疲力尽】几率", haveOutput = "SapChance", flag = "sap", { format = "{0:output:SapChance}%",
	...
	{ label = "【精疲力尽】持续时间加成", haveOutput = "SapDurationMod", flag = "sap", { format = "x {2:output:SapDurationMod}",
...
{ label = "终结", haveOutput = "CullPercent", { format = "{0:output:CullPercent}%", { modName = { "CullPercent", "CriticalCullPercent" }, cfg = "skill" } } },
} },
} },
...
{ 1, "Life", 2, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "生命", data = {
	...
	{ label = "回复", { format = "{1:output:LifeRegen} ({1:output:LifeRegenPercent}%)", 
		{ label = "源", modName = { "LifeRegen", "LifeRegenPercent", "LifeDegen", "LifeDegen", "LifeRecovery" }, modType = "BASE" },
...
{ 1, "Armour", 3, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "护甲", data = {
	...
	{ label = "额外护甲几率", haveOutput = "MoreArmourChance", { format = "{0:output:MoreArmourChance}%", { modName = "MoreArmourChance" }, }, },
...
} }, { defaultCollapsed = true, label = "格挡后回复", data = {
...
{ label = "格挡持续时间", { format = "{2:output:BlockDuration}s", 
	...
	{ label = "冰冻持续时间", { format = "{1:output:SelfFreezeDuration}%", { modName = "SelfFreezeDuration" }, }, },
	{ label = "冰缓持续时间", { format = "{1:output:SelfChillDuration}%", { modName = "SelfChillDuration" }, }, },
	{ label = "感电持续时间", { format = "{1:output:SelfShockDuration}%", { modName = "SelfShockDuration" }, }, },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "承受伤害", data = {
	...
	{ label = "估计存活时间",{ format = "{2:output:EHPsurvivalTime}s", { breakdown = "EHPsurvivalTime" }, },}
}, }, { defaultCollapsed = false, label = "最大承受击中伤害", data = {
	extra = "第二小承伤: {0:output:SecondMinimalMaximumHitTaken}",
	colWidth = 95,
	{
		{ format = "第二小:" },
		{ format = "物理:" },
