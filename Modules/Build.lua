...
function buildMode:Init(dbFileName, buildName, buildXML, convertBuild)
	...
	self.displayStats = {
		...
		{ stat = "ManaPercentCost", label = "魔力消耗百分比", fmt = "d%%", color = colorCodes.MANA, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaPercentHasCost end },
		{ stat = "ManaPerSecondCost", label = "每秒魔力消耗", fmt = ".2f", color = colorCodes.MANA, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaPerSecondHasCost end },
		{ stat = "ManaPercentPerSecondCost", label = "每秒魔力消耗百分比", fmt = ".2f%%", color = colorCodes.MANA, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaPercentPerSecondHasCost end },
		...
		{ stat = "LifePercentCost", label = "生命消耗百分比", fmt = "d%%", color = colorCodes.LIFE, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.LifePercentHasCost end },
		{ stat = "LifePerSecondCost", label = "每秒生命消耗", fmt = ".2f", color = colorCodes.LIFE, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.LifePerSecondHasCost end },
		{ stat = "LifePercentPerSecondCost", label = "每秒生命消耗百分比", fmt = ".2f%%", color = colorCodes.LIFE, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.LifePercentPerSecondHasCost end },
		...
		{ stat = "ESPerSecondCost", label = "每秒能量护盾消耗", fmt = ".2f", color = colorCodes.ES, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ESPerSecondHasCost end },
		{ stat = "ESPercentPerSecondCost", label = "每秒能量护盾消耗百分比", fmt = ".2f%%", color = colorCodes.ES, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ESPercentPerSecondHasCost end },
		...
		{ stat = "RagePerSecondCost", label = "怒火每秒消耗", fmt = ".2f", color = colorCodes.RAGE, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.RagePerSecondHasCost end },
		{ },
		...
		{ },
		{ stat = "TotalDegen", label = "总降低回复", fmt = ".1f", lowerIsBetter = true },
