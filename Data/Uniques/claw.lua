...
{variant:1,2}附加 10 - 12 基础物理伤害
{variant:3}附加 25 - 30 基础物理伤害
攻击速度提高 5%
...
{variant:3,4}攻击击中每个敌人会回复 +25 生命
{variant:1,2,3}施法速度提高 (8-12)%
{variant:4}施法速度提高 (15-20)%
+(30-40) 最大魔力
{variant:1,2,3}你的法术击中每个敌人会回复 +(5-8) 生命
{variant:4}你的法术击中每个敌人会回复 +(15-20) 生命
{variant:1}每 5% 的攻击格挡率会使法术伤害提高 6%
{variant:2,3,4}每 5% 的攻击格挡率会使法术伤害提高 8%
]],[[
精华收割器
刺眼钩
版本: 1.3.0以前
...
{variant:1,2}双持爪时攻击格挡率提高 8%
{variant:1,2}物理伤害提高 (140-180)%
{variant:1,2}附加 1 - 200 基础闪电伤害
{variant:3}附加 1 - (600-700) 基础闪电伤害
攻击速度提高 (20-30)%
+(30-40) 最大能量护盾
{variant:2,3}灵能护体
{variant:1}生命偷取会套用于能量护盾
{variant:2}从能量护盾偷取中获得的最大总恢复量降低 50%
{variant:2,3}能量护盾回满时不会取消来自攻击的能量护盾偷取效果
]],[[
思动之手
袭眼钩
联盟: 裂隙
