...
异能魔力
{variant:1}+(16-20)% 火焰与混沌抗性
{variant:2}+(16-20)% 冰霜与混沌抗性
{variant:3}+(16-20)% 闪电与混沌抗性
{variant:4}+(31-35) 力量和敏捷
{variant:5}+(31-35) 敏捷和智慧
{variant:6}+(31-35) 力量和智慧
{variant:7}地雷投掷速度提高 (14-16)%
{variant:8}你在专注时触发插入的法术，它有 0.25 秒冷却时间
{variant:8}专注的冷却回复速度提高 (5-8)%
{variant:9}专注时造成的异常状态持续时间延长 (161-180)%
{variant:10}【阻灵术】持续期间，被击中时有 (10-12)% 几率避免元素伤害
]],
[[
深渊之唤
艾兹麦坚盔
