...
异能魔力
{variant:1}{crafted}+(10-25) 力量
{variant:2}{crafted}+(10-25) 敏捷
{variant:3}{crafted}+(10-25) 智慧
{variant:1,2,3}{crafted}+(7-18) 品质
{variant:4}{crafted}+(8-15)% 火焰与混沌抗性
{variant:5}{crafted}+(8-15)% 冰霜与混沌抗性
{variant:6}{crafted}+(8-15)% 闪电与混沌抗性
{variant:7}{crafted}+(6-17) 力量和敏捷
{variant:8}{crafted}+(6-17) 敏捷和智慧
{variant:9}{crafted}+(6-17) 力量和智慧
{variant:10}{crafted}地雷投掷速度提高 (7-12)%
{variant:11}{crafted}专注时触发插槽内的法术
{variant:12}{crafted}专注时造成的异常状态持续时间延长 (81-140)%
{variant:13}{crafted}【阻灵术】持续期间，被击中时有 (6-9)% 几率避免元素伤害
]],
[[
深渊之唤
艾兹麦坚盔
