...
skills["SupportAdditionalXP"] = {
	name = "启蒙(辅)",
	description = "辅助任意技能石。该技能石达到 2 级后，可以给被辅助的技能石增加花费和保留加成。不能辅助非宝石技能。",
	color = 3,
	support = true,
	requireSkillTypes = { },
	addSkillTypes = { },
...
skills["SupportAdditionalXPPlus"] = {
	name = "启蒙（强辅）",
	description = "辅助任意技能石。当宝石达到2级或以上时，可以给被辅助的技能石增加花费和保留加成。不能辅助非宝石技能。",
	color = 3,
	support = true,
	requireSkillTypes = { },
	addSkillTypes = { },
...
skills["SupportHexBloom"] = {
	name = "魔蛊绽放辅助",
	description = "辅助魔蛊技能。光环或诅咒区域中的魔蛊无法被转移。",
	color = 3,
	support = true,
	requireSkillTypes = { SkillType.Hex, SkillType.AppliesCurse, },
	addSkillTypes = { },
