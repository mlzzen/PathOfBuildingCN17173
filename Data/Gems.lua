...
return {
	...
	["Metadata/Items/Gems/SkillGemElementalHit"] = {
		...
		tagString = "攻击, 投射物, 近战, 打击, 火焰, 冰霜, 闪电, 效果区域, 弓箭",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemWildStrike"] = {
		...
		tagString = "攻击, 近战, 打击, 闪电, 冰霜, 火焰, 投射物, 效果区域, 连锁",
		reqStr = 40,
		reqDex = 60,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemStormBind"] = {
		...
		tagString = "法术, 效果区域, 持续吟唱, 闪电, 持续时间",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
