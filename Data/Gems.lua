...
return {
	...
	["Metadata/Items/Gems/SkillGemVaalGlacialHammer"] = {
		...
		tagString = "攻击, 近战, 打击, 持续时间, 效果区域, 瓦尔, 冰霜",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalLightningWarp"] = {
		...
		tagString = "法术, 效果区域, 持续时间, 瓦尔, 闪电, 位移, 旅行",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalLightningStrike"] = {
		...
		tagString = "攻击, 近战, 打击, 持续时间, 瓦尔, 闪电, 投射物",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalMoltenShell"] = {
		...
		tagString = "法术, 效果区域, 持续时间, 火焰, 物理, 瓦尔, 护卫",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalBurningArrow"] = {
		...
		tagString = "攻击, 投射物, 效果区域, 瓦尔, 火焰, 弓箭",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemFreezeMine"] = {
		...
		tagString = "地雷, 暴击, 法术, 投射物, 冰霜, 光环, 效果区域",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalCyclone"] = {
		...
		tagString = "攻击, 效果区域, 持续时间, 瓦尔, 近战, 位移, 持续吟唱, 物理",
		reqStr = 40,
		reqDex = 60,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalLightningTrap"] = {
		...
		tagString = "陷阱, 暴击, 法术, 投射物, 持续时间, 瓦尔, 闪电",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalFireResistAura"] = {
		...
		tagString = "光环, 法术, 效果区域, 持续时间, 瓦尔, 火焰",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalColdResistAura"] = {
		...
		tagString = "光环, 法术, 效果区域, 持续时间, 瓦尔, 冰霜",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalLightningResistAura"] = {
		...
		tagString = "光环, 法术, 效果区域, 持续时间, 瓦尔, 闪电",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemAbyssalCry"] = {
		...
		tagString = "战吼, 效果区域, 持续时间, 火焰, 攻击, 触发, 近战",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalBladeVortex"] = {
		...
		tagString = "暴击, 法术, 效果区域, 持续时间, 瓦尔, 物理",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemLightningTowerTrap"] = {
		...
		tagString = "陷阱, 暴击, 法术, 持续时间, 效果区域, 闪电",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalEarthquake"] = {
		...
		tagString = "攻击, 效果区域, 持续时间, 瓦尔, 猛击, 近战",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalBlight"] = {
		...
		tagString = "法术, 混沌, 效果区域, 持续时间, 瓦尔, 新星, 持续吟唱",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVoltaxicBurst"] = {
		...
		tagString = "法术, 效果区域, 混沌, 闪电, 新星, 持续时间",
		reqStr = 0,
		reqDex = 40,
		reqInt = 60,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemAbsolution"] = {
		...
		tagString = "法术, 召唤生物, 持续时间, 效果区域, 物理, 闪电",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemBoneshatter"] = {
		...
		tagString = "攻击, 近战, 打击, 效果区域, 持续时间, 物理",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemExplosiveConcoction"] = {
		...
		tagString = "攻击, 效果区域, 火焰, 冰霜, 闪电, 投射物",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemGalvanicField"] = {
		...
		tagString = "法术, 效果区域, 持续时间, 闪电, 连锁, 法球",
		reqStr = 0,
		reqDex = 0,
		reqInt = 100,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemAlchemistsMark"] = {
		...
		tagString = "法术, 诅咒, 咒印, 效果区域, 持续时间, 火焰, 混沌",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVolcanicFissure"] = {
		...
		tagString = "近战, 攻击, 投射物, 效果区域, 猛击, 火焰",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalVolcanicFissure"] = {
		...
		tagString = "近战, 攻击, 投射物, 效果区域, 猛击, 火焰, 瓦尔",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalCleave"] = {
		...
		tagString = "攻击, 效果区域, 物理, 瓦尔, 持续时间, 近战",
		reqStr = 60,
		reqDex = 40,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalCausticArrow"] = {
		...
		tagString = "攻击, 投射物, 效果区域, 持续时间, 混沌, 瓦尔, 弓箭",
		reqStr = 0,
		reqDex = 100,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalMoltenStrike"] = {
		...
		tagString = "攻击, 投射物, 效果区域, 近战, 打击, 火焰, 连锁, 瓦尔",
		reqStr = 100,
		reqDex = 0,
		reqInt = 0,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalSmite"] = {
		...
		tagString = "闪电, 攻击, 效果区域, 持续时间, 近战, 打击, 光环, 瓦尔",
		reqStr = 60,
		reqDex = 0,
		reqInt = 40,
		defaultLevel = 20,
	...
	["Metadata/Items/Gems/SkillGemVaalChargedAttack"] = {
		...
		tagString = "攻击, 效果区域, 持续吟唱, 物理, 瓦尔, 近战",
		reqStr = 0,
		reqDex = 60,
		reqInt = 40,
		defaultLevel = 20,
