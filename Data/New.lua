...
三头威仪
潜能之戒
源: 传奇Boss【瓦尔女王阿兹里」】 专属掉落（【生贽之尖】3词【诱人的深渊】4词）
...
有 1 个插槽
此物品上装备的【瓦尔技能石】等级 +2
{variant:1}插入的瓦尔技能的伤害总增 150%
{variant:2}插入的瓦尔技能每次施放需要的灵魂量总降 30%
{variant:3}可以储存灵魂供插入的瓦尔技能额外使用 1 次
{variant:4}插入的瓦尔技能击中时无视敌方怪物的抗性
{variant:5}插入的瓦尔技能击中时无视敌方怪物的物理伤害减免物理
{variant:6}插入的瓦尔技能使用时提供灵巧效果
{variant:7}若你近期内使用过插入的瓦尔技能，则获得提速尾流效果
{variant:8}插入的瓦尔技能的效果区域扩大 60%
{variant:9}{tags:speed}插入的瓦尔技能的投射物速度加快 80%速度
{variant:10}插入的瓦尔技能效果持续时间提高 80%
{variant:11}插入的瓦尔技能的阻灵术持续时间缩短 30%
{variant:12}插入的瓦尔技能击中时伤害特别幸运
{variant:13}插入的瓦尔技能的光环效果提高 50%
]],
...
版本: 恶语术
版本: 物品数量
{variant:1}效果区域扩大 (15-25)%
{variant:2}周围敌人被致盲
{variant:3}插入的技能石的消耗及保留加成为原来的 80%
{variant:4}你所施放诅咒的效果提高 (10-15)%
{variant:5}技能效果持续时间延长 (15-25)%
{variant:6}周围敌人被碾压
{variant:7}此物品上装备的技能石等级 +2
{variant:8}耐力球、狂怒球、暴击球下限 +1
{variant:9}冷却回复速度提高 (8-12)%
{variant:10}你技能的非诅咒类光环效果提高 (10-15)%
{variant:11}技能可以额外发射 1 个投射物
{variant:12}周围敌人有恶语术效果
{variant:13}物品掉落数量提高 (5-7)%
可在腐化时添加词缀
最大生命提高 (30-40)%，并且火焰抗性等量降低
最大魔力提高 (30-40)%，并且冰霜抗性等量降低
全局最大能量护盾提高 (30-40)%，并且闪电抗性等量降低
混沌抗性归零
已污染
]],
...
闪避值提高 (170-250)%
+(19-29)% 混沌抗性
你身上每层中毒效果都使伤害提高 15%，最大提升至 75%
你身上每层中毒效果都使移动速度加快 10%，最大 50%
若你身上的中毒效果少于 5 层
则你的旅行技能施加的中毒效果反射给你自己
]],
[[
钢铁蠕虫
宽矢箭袋
...
闪避值与护甲提高 (30-60)%
造成非物理伤害
发射火焰投射物的攻击最多消耗 1 个额外钢刃碎片
你总共消耗 12 枚钢刃碎片后技能在 4 秒内发射 3 枚额外投射物
]],
[[
协约的遗物
螺纹法杖
...
固定基底词缀: 0
+(5-10) 全属性
每个影响你的苍白之凝珠宝都使召唤生物持续伤害加成+6%，最多 +30%
]],
[[
库加尔的凝视
安睡之凝珠宝
联盟: 深渊
+(10-20) 智慧
每个影响你的安睡之凝珠宝都使你身上的秘术增强效果提高 8%，最多 40%
]],
[[
正义之鳞
魂相魔盾
...
+(40-70) 最大生命
+(40-70) 最大魔力
每 100 点最大生命或最大魔力（取其低值）附加 (3-4) 到 (7-8) 点火焰伤害
若最大生命和最大魔力在 500 以内，则免受点燃或感电影响
]],
[[
乌勒曼的凝视
锐利之凝珠宝
...
固定基底词缀: 0
+(10-20) 敏捷
每个影响你的锐利之凝珠宝都使投射物碰撞地面时有 4% 的几率产生连锁效果，最多 20%
]],
[[
特克罗的凝视
凶残之凝珠宝
...
固定基底词缀: 0
+(10-20) 力量
每个影响你的凶残之凝珠宝都使你的主手暴击率提高 20%，最多 100%
每个影响你的凶残之凝珠宝都使你的副手暴击伤害加成 +10，最多 50%
]],
[[
马赫索托之诈
冷钢鸢盾
