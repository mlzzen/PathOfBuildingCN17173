		...
		lang={
			["Simplified Chinese"]={
				[1]={
					...
					text="你保留魔力的非祝福技能在你身上有辅助技能的光环时被禁用"
				}
			}
		},
		stats={
		...
		lang={
			["Simplified Chinese"]={
				[1]={
					...
					text="被辅助技能施加死亡凋零时有 {0}% 的几率额外施加一个死亡凋零减益效果"
				}
			}
		},
		stats={
